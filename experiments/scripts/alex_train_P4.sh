...
if [[ ! -z  ${EXTRA_ARGS_SLUG}  ]]; then
  NET_FINAL=for_transfer_frcnn_weights/P4/${NET}/${TRAIN_IMDB}/${EXTRA_ARGS_SLUG}/${NET}_faster_rcnn_iter_${ITERS}.ckpt
else
  NET_FINAL=for_transfer_frcnn_weights/P4/${NET}/${TRAIN_IMDB}/default/${NET}_faster_rcnn_iter_${ITERS}.ckpt
fi
set -x
