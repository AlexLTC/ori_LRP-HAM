...
def parse_args():
  ...
  """
    ...
    parser.add_argument('--model', dest='model',
                        ...
                        # default='/home/irislab/fastrcnn/L-RPN-HAM_DET/drl-weights-ori-pascal_voc-5w-betasoftmax110000/output/res101_drl_rpn/voc_2007_trainval/res101_drl_rpn_iter_110000.ckpt',
                        default='/home/irislab/fastrcnn/論文用模型/HAM/HAM-weights-FPN@P4-beta-mask-pascal/output/res101_drl_rpn/voc_2007_trainval/res101_drl_rpn_iter_110000.ckpt',
...
if __name__ == '__main__':
    ...
    logger = setup_logger("drl-rpn", save_dir='/home/irislab/fastrcnn/論文用模型/test/HAM-FPN@P4-beta-mask-pascal/', filename="log_test.txt")
