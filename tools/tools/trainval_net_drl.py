...
def parse_args():
  ...
  """
    ...
    parser.add_argument('--cfg', dest='cfg_file',
                        ...
                        default='experiments/cfgs/drl-rpn-P4.yml', type=str)
    parser.add_argument('--weight', dest='weight',
                        help='initialize with pretrained model weights',
                        default='/home/irislab/fastrcnn/論文用模型/faster rcnn/fr-rcnn-weights-FPN@P4-pascal/res101_faster_rcnn_iter_70000.ckpt',
                        type=str)
    # default = '/media/data/drl-rpn/fr-rcnn-voc2007-2012-trainval/vgg16_faster_rcnn_iter_180000.ckpt'

    parser.add_argument('--save', dest='save_path',
                        help='path for saving model weights',
                        default='/home/irislab/fastrcnn/論文用模型/HAM/drlori-weights-FPN@P4-pascal/',
                        type=str)
...
if __name__ == '__main__':
    ...
    logger = setup_logger("drl-rpn", save_dir=args.save_path, filename="log_train.txt")
    logger.info('Called with args:')
    logger.info(args)
    logger.info('Using attention alpha:')
    logger.info(cfg.DRL_RPN.ALPHA)
